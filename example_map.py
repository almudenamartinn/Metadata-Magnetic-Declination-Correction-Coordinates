...
# https://www.ngdc.noaa.gov/geomag/calculators/magcalc.shtml does not account for altitude in declination calculation
...
# Map visualization
visualizacion_en_mapa(latitud_final, longitud_final)
